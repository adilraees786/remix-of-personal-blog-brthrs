...
const About = () => {
  useDocumentHead({
    title: 'About',
    description: 'About Blogify — exploring the intersection of fashion, technology, business, and lifestyle.',
    canonicalPath: '/about',
  });
  return (
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Welcome to Blogify, where diverse worlds converge. Founded with a passion for exploring 
