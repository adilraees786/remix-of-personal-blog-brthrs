...
const Privacy = () => {
  useDocumentHead({
    ...
    description: 'Privacy Policy for Blogify Blog. How we collect, use, and protect your information.',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
            <section>
              ...
              <p>
                At Blogify Blog, we collect information you provide directly to us, such as when you subscribe to our newsletter, leave comments, or contact us. We also automatically collect certain information about your device when you use our website.
              </p>
            ...
            <section>
              ...
              <p>
                If you have any questions about this Privacy Policy or our privacy practices, please contact us at privacy@Blogifyblog.com or through our website contact form.
              </p>
            </section>
